...
const InquiryStickyFooter: React.FC<InquiryStickyFooterProps> = ({ productName }) => {
    return (
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                ...
                <div className="hidden sm:flex items-center gap-4">
                    <div className="w-10 h-10 bg-gray-50 flex items-center justify-center rounded-sm overflow-hidden border border-gray-100">
                        <img
                            src="https://placehold.co/100x100?text=P"
                            alt={productName}
                ...
                {/* Primary Action */}
                <div className="flex-grow sm:flex-grow-0 flex items-center gap-3">
                    <button className="flex-grow sm:flex-grow-0 py-3 px-8 bg-[#cc0000] text-white text-[11px] font-black uppercase tracking-[0.15em] rounded-sm hover:bg-black transition-colors duration-300 shadow-lg shadow-red-900/10">
                        Request To Call Back
                    </button>

                    <button className="p-3 bg-[#005099] text-white rounded-sm hover:bg-black transition-colors duration-300 shadow-lg shadow-blue-900/10 hidden md:block">
                        <Mail size={18} />
                    </button>
